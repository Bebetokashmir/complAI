...
import type { InputType } from "@/types/assessment";
...
export function GdprForm() {
  ...
  const [result, setResult] = useState<GdprAssessmentResult | null>(null);
    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      >
        ...
        <TabsContent value="text">
          <Textarea
            placeholder="Describe your product or service: what personal data do you collect, from whom, why, where is it stored, who has access, do you share it with third parties…"
      ...
      {result && <GdprReport result={result} />}
    </div>
  );
}
